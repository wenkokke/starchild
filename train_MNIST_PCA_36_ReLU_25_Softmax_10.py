...
train_images = pca.fit_transform(
    train_images.reshape((-1, 784))).reshape((-1, 36))
test_images = pca.transform(
    test_images.reshape((-1, 784))).reshape((-1, 36))

# Train network
model = keras.Sequential([
    keras.layers.Dense(25, activation='relu', input_shape=(36,)),
...
model.save('models/MNIST_PCA_36_ReLU_25_Softmax_10.h5')
...
with open('models/MNIST_PCA_36_ReLU_25_Softmax_10.ideal.pkl', 'wb') as fp:
    pkl.dump(ideal, fp)
